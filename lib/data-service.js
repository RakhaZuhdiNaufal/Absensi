...
let mockStudents = [
  ...
  },
  {
    ...
    class: 'XII RPL 1',
    major: 'Rekayasa Perangkat Lunak',
    tempat_pkl: 'PT Digital Inovasi Asia',
    pembimbing_id: 2,
    pembimbing_name: 'Pak Ridwan',
    status: 'Aktif PKL',
    periode_mulai: '2026-07-01',
  ...
  },
  {
    ...
    class: 'XII RPL 1',
    major: 'Rekayasa Perangkat Lunak',
    tempat_pkl: 'PT Cyber Media Solusindo',
    pembimbing_id: 2,
    pembimbing_name: 'Pak Ridwan',
    status: 'Aktif PKL',
    periode_mulai: '2026-07-01',
  ...
  },
  {
    ...
    class: 'XII RPL 1',
    major: 'Rekayasa Perangkat Lunak',
    tempat_pkl: 'PT Teknologi Nusantara',
    pembimbing_id: 2,
    pembimbing_name: 'Pak Ridwan',
    status: 'Aktif PKL',
    periode_mulai: '2026-07-01',
  ...
  },
  {
    ...
    class: 'XII RPL 2',
    major: 'Rekayasa Perangkat Lunak',
    tempat_pkl: 'PT Solusi Data Utama',
    pembimbing_id: 2,
    pembimbing_name: 'Pak Ridwan',
    status: 'Aktif PKL',
    periode_mulai: '2026-07-01',
  ...
  },
  {
    ...
    class: 'XII RPL 2',
    major: 'Rekayasa Perangkat Lunak',
    tempat_pkl: 'PT Media Kreatif Sentosa',
    pembimbing_id: 2,
    pembimbing_name: 'Pak Ridwan',
    status: 'Aktif PKL',
    periode_mulai: '2026-07-01',
    ...
    try {
      ...
      if (studentIds.length > 0) {
        ...
        attendanceToday = (rowsToday || []).map(r => ({
          ...r,
          attendance_date: typeof r.attendance_date === 'string' ? r.attendance_date.split('T')[0] : (r.attendance_date ? new Date(r.attendance_date).toISOString().split('T')[0] : todayStr)
        }));
