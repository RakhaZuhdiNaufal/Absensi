    ...
    <div className="min-h-screen bg-[#f9f8f3] text-[#57564F] pb-24">
              ...
              <div className="flex gap-2 shrink-0">
                {[
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-xl font-normal transition-all shrink-0 ${
                      statusFilter === tab.id
                        ? 'bg-[#57564F] text-[#F8F3CE] shadow-xs'
                        : 'bg-[#f9f8f3] text-[#7A7A73] hover:text-[#57564F] border border-[#DDDAD0]'
                    }`}
                  >
                    {tab.label}
                  </button>
      ...
      {selectedAttendance && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-md w-full p-5 space-y-4 max-h-[90vh] overflow-y-auto relative shadow-2xl border border-[#DDDAD0]">
            <button
