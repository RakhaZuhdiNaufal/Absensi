...
export default function AdminSiswaPage() {
  ...
  const handleAddSubmit = async (e) => {
    ...
    try {
      ...
      setFormSuccess('Siswa berhasil ditambahkan ke database!');
      await reloadStudents();
      setTimeout(() => {
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      setFormSuccess('Profil siswa berhasil diperbarui di database!');
      await reloadStudents();
      setTimeout(() => {
  ...
  return (
    <div className="min-h-screen bg-[#f9f8f3] text-[#57564F] pb-24 md:pb-12">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <span className="text-xs text-[#DDDAD0] font-semibold flex items-center gap-1.5 uppercase tracking-wider mb-1">
                  <Users className="w-4 h-4 text-[#F8F3CE]" /> Administrator Panel
                </span>
                ...
                <p className="text-xs text-[#DDDAD0]/80 mt-1">
                  Kelola data siswa, radius lokasi presensi, dan data tersimpan langsung ke database.
                </p>
              </div>

              <button
                onClick={handleOpenAdd}
                className="bg-[#F8F3CE] hover:bg-white text-[#57564F] text-xs font-bold px-4 py-2.5 rounded-xl shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer shrink-0 active:scale-95"
              >
        ...
        <div className="max-w-6xl mx-auto md:max-w-none p-4 md:p-6 space-y-4">
          ...
          {filteredStudents.length === 0 ? (
            <div className="bg-white rounded-3xl p-12 text-center border border-[#DDDAD0] space-y-3">
              ...
              <button
                onClick={handleOpenAdd}
                className="inline-flex items-center gap-1.5 bg-[#57564F] text-[#F8F3CE] text-xs font-bold px-4 py-2 rounded-xl active:scale-95 transition-all"
              >
                  ...
                  <div>
                    ...
                    <div className="mt-3.5 space-y-1.5 text-xs">
                      ...
                      <div className="flex items-center gap-2 text-[#7A7A73]">
                        ...
                        <span className="truncate">Pembimbing: <b className="text-[#57564F]">{st.pembimbing_name || 'Pembimbing PKL'}</b></span>
                      </div>
                      <div className="flex items-center gap-2 text-[#7A7A73]">
        ...
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-3 sm:p-4">
          <div className="bg-white w-full max-w-lg rounded-3xl p-6 shadow-2xl space-y-4 max-h-[92vh] overflow-y-auto">
            ...
            <form onSubmit={handleAddSubmit} className="space-y-3 text-xs">
              ...
              {/* Titik & Radius Lokasi PKL */}
              <div className="bg-[#f9f8f3] p-3 rounded-2xl border border-[#DDDAD0] space-y-2">
                <span className="block text-xs font-bold text-[#57564F]">Titik & Radius Lokasi PKL (Presensi)</span>
              ...
              {/* Titik & Radius Lokasi Alternatif / Rumah */}
              <div className="bg-[#f9f8f3] p-3 rounded-2xl border border-[#DDDAD0] space-y-2">
                <span className="block text-xs font-bold text-[#57564F]">Titik & Radius Lokasi Alternatif (WFH / Rumah)</span>
                <div className="grid grid-cols-3 gap-2 text-xs">
                  <div>
                    <label className="block text-[11px] text-[#7A7A73] mb-0.5">Latitude</label>
                    <input
          ...
          <div className="bg-white w-full max-w-lg rounded-3xl p-6 shadow-2xl space-y-4 max-h-[92vh] overflow-y-auto">
            <div className="flex items-center justify-between pb-3 border-b border-[#DDDAD0]">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-sm font-bold text-[#57564F]">Edit Data Siswa</h3>
            ...
            <form onSubmit={handleEditSubmit} className="space-y-3 text-xs">
              ...
              {/* Titik & Radius Lokasi Alternatif */}
              <div className="bg-[#f9f8f3] p-3 rounded-2xl border border-[#DDDAD0] space-y-2">
                <span className="block text-xs font-bold text-[#57564F]">Titik & Radius Alternatif (WFH / Rumah)</span>
                <div className="grid grid-cols-3 gap-2 text-xs">
                  <div>
                    <label className="block text-[11px] text-[#7A7A73] mb-0.5">Latitude</label>
                    <input
          ...
          <div className="bg-white w-full max-w-sm rounded-3xl p-5 shadow-2xl space-y-4 text-center">
            ...
            <div>
              ...
              <p className="text-xs text-[#7A7A73] mt-1.5 leading-relaxed">
                Anda akan menghapus akun <b>{selectedStudent.name}</b> (NIS: {selectedStudent.nis}). Data tersimpan di database akan dihapus permanen.
              </p>
            </div>
      ...
      {/* MODAL / DRAWER: Riwayat Absen & Jurnal Siswa */}
            ...
            <div className="flex items-center justify-between pb-3 border-b border-[#DDDAD0]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-[#7A7A73]">NIS: {selectedStudent.nis} &bull; {selectedStudent.tempat_pkl || 'Lokasi belum diatur'}</p>
                </div>
              </div>
